...
const CategoryCard = () => {
  return (
    <div className="flex flex-col justify-center gap-10 md:grid md:grid-cols-3 items-center">
      {data.map((list) => (
        <div
        ...
        >
          {/* <Image
            src={list.category.image}
            alt={`${list.category.title}_image`}
            width={250}
            height={230}
            className="object-center object-cover rounded-full h-10 w-10 bg-sushii-coral-10"
          /> */}
